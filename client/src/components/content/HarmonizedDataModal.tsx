  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative transform overflow-hidden rounded-xl bg-white shadow-2xl transition-all w-full max-w-6xl max-h-[90vh] flex flex-col">
          {/* Header */}
          <div className="bg-white px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 flex flex-col items-center px-4">
                <h3 className="text-xl font-bold text-gray-900 mb-1" id="modal-title">
              ...
              <button
                onClick={onClose}
                className="bg-gray-100 rounded-lg p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-200 transition-colors shrink-0"
              >
